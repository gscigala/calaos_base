    ...
    button_quit(NULL)
{
    ...
    if (edje_object_part_exists(elm_layout_edje_get(layout), "button.quit"))
    {
        button_quit = edje_object_part_external_object_get(elm_layout_edje_get(layout), "button.quit");
