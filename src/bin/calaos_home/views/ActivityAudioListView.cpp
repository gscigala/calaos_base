    ...
    in_edit_mode(false)
{
    ...
    Evas_Object *btn = edje_object_part_external_object_get(elm_layout_edje_get(layout), "button.browser.back");
    elm_object_text_set(btn, _("Back"));

    btn = edje_object_part_external_object_get(elm_layout_edje_get(layout), "button.browser.root");
